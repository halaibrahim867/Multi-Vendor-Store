                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="top-left">
                                <ul class="menu-top-link">
                                    ...
                                    <li>
                                        <div class="select-position">
                                            <form action="{{ LaravelLocalization::getLocalizedURL(App::getLocale(), URL::current()) }}" method="get">
                                                <select name="locale" onchange="window.location.href=this.value">
                                                    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                                        <option value="{{ LaravelLocalization::getLocalizedURL($localeCode, URL::current()) }}" @selected($localeCode == App::currentLocale())>
                                                            {{ $properties['native'] }}
                                                        </option>
                                                    @endforeach
                                                </select>
